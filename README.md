...
- This assignment is to implement a specified program which is written on Python.
...
To run itemsets.py, type the following in the terminal: `python itemsets.py`.
